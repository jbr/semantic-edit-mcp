...
impl RustParser {
    pub fn find_function_by_name<'a>(tree: &'a Tree, source_code: &str, function_name: &str) -> Result<Option<Node<'a>>> {
    ...
    pub fn find_struct_by_name<'a>(tree: &'a Tree, source_code: &str, struct_name: &str) -> Result<Option<Node<'a>>> {
        let query_text = format!(
            r#"
            (struct_item
    ...
    pub fn find_impl_block_for_type<'a>(tree: &'a Tree, source_code: &str, type_name: &str) -> Result<Vec<Node<'a>>> {
        let query_text = format!(
            r#"
            (impl_item
